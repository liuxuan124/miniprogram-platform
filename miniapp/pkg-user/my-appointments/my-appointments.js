// pkg-user/my-appointments/my-appointments.js — 我的预约列表
...
Page({
  ...
  onRebookTap(e) {
    ...
    e.stopPropagation()
    if (serviceId) {
      wx.navigateTo({ url: `/pkg-trade/appointment-book/appointment-book?id=${serviceId}` })
    }
  },

  /** 跳转预约服务列表 */
  onGoBookTap() {
    wx.navigateTo({ url: '/pkg-user/appointment-list/appointment-list' })
  },
})
