// pkg-trade/appointment-calendar/appointment-calendar.js — 预约日历页
...
Page({
  ...
  onBookTap() {
    ...
    wx.navigateTo({
      url: `/pkg-trade/appointment-book/appointment-book?date=${this.data.selectedDate}&start=${slot.start_time}&end=${slot.end_time}`,
    })
  },
