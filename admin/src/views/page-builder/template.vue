<template>
  <div class="template-page">
    <div class="ph">
      ...
      <div class="ps">选择预设页面模板，快速创建首页、活动页、内容页、商城页、会员页与预约页。</div>
    </div>
    ...
    <div class="toolbar">
      ...
      <div class="mla actions">
        <button class="btn" @click="refreshTemplates">刷新</button>
        <button class="btn btn-p" @click="openCreateTemplateHint">+ 新建空白页面</button>
      </div>
    </div>
...
const filteredTemplates = computed(() => {
  return templates.value.filter((tpl) => {
    ...
    const byIndustry = !selectedIndustry.value || (tpl as any).industryCode === selectedIndustry.value || (tpl as any).industry_code === selectedIndustry.value
    return byName && byCategory && byScene && byIndustry
  })
})

/** Build a component instance using registry defaults, with optional overrides */
