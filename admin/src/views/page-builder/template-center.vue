...
function fallbackTemplates(): TemplateUI[] {
  return [
    ...
    },
    {
      id: 2010,
      name: '商城成交首页模板',
      description: '面向成交转化的商城首页：搜索、轮播、分类导航、秒杀、优惠券、商品列表与会员卡。',
      category: 'home',
      created_at: '',
      priority: 'P0',
      scene: 'sales',
      ...
      dsl: makeDsl('商城成交首页', 'home', 'pages/index/index', [
        ...
        makeComp('pl1', ComponentType.ProductList, { title: '人气商品', columns: 2, limit: 8 }),
        makeComp('mc1', ComponentType.MemberCard, { title: '会员专享', benefits: ['会员价', '积分翻倍', '包邮权益'] }),
      ]),
    },
    {
      id: 2011,
      name: '内容发现流模板',
      description: '内容发现页：品牌顶栏、分区标题、文章流、笔记流与热门资讯，适合内容发布场景。',
      category: 'discover',
      created_at: '',
      priority: 'P0',
      scene: 'publish',
      ...
      style: 'minimal',
      industryCode: 'content_ip',
      dsl: makeDsl('内容发现流', 'discover', 'pages/discover/discover', [
        makeComp('bh1', ComponentType.BrandHeader, { logo_text: '发现', title: '内容发现', subtitle: '精选文章与热门资讯', style_type: 'plain' }),
        makeComp('st1', ComponentType.SectionTitle, { title: '精选文章', subtitle: '深度阅读' }),
        makeComp('af1', ComponentType.ArticleFeed, { layout: 'list', page_size: 10, show_cover: true, show_date: true }),
        makeComp('st2', ComponentType.SectionTitle, { title: '灵感笔记', subtitle: '轻内容' }),
        makeComp('nf1', ComponentType.NoteFeed, { page_size: 8, show_category_tabs: false }),
        makeComp('st3', ComponentType.SectionTitle, { title: '今日热门', subtitle: '资讯速览' }),
        makeComp('hn1', ComponentType.HotNews, { title: '今日热门资讯', limit: 6 }),
      ], '#FFF8F1'),
    },
    {
      id: 2012,
      name: '会员权益页模板',
      description: '会员权益落地页：会员卡、优惠券、卖点卡片与品牌介绍，适合留存运营。',
      category: 'member',
      created_at: '',
      priority: 'P0',
      scene: 'retention',
      ...
      style: 'premium',
      industryCode: 'content_ip',
      dsl: makeDsl('会员权益页', 'member', 'pages/member-center/member-center', [
        makeComp('mc1', ComponentType.MemberCard, { title: '会员中心', benefits: ['专属折扣', '积分加速', '优先客服'] }),
        makeComp('cp1', ComponentType.Coupon, { title: '会员专属券', coupons: [{ name: '会员满减券', threshold: 9900 }, { name: '生日礼券', threshold: 0 }] }),
        makeComp('fc1', ComponentType.FeatureCards, { title: '会员特权', cards: [{ title: '专属价', desc: '全场会员折扣' }, { title: '积分翻倍', desc: '消费加速累积' }, { title: '优先服务', desc: '专属客服通道' }] }),
        makeComp('bi1', ComponentType.BrandIntro, { title: '关于会员计划', subtitle: '持续成长的权益体系', desc: '加入会员即可解锁优惠券、积分与专属内容权益。' }),
      ], '#f8fafc'),
    },
    {
      id: 2013,
      name: '知识资料库落地页模板',
      description: '知识资料库落地页：品牌顶栏、分区标题、文章列表、表单入口与联系方式。',
      category: 'custom',
      created_at: '',
      priority: 'P1',
      scene: 'service',
      ...
      dsl: makeDsl('知识资料库', 'custom', 'pages/resources/resources', [
        makeComp('bh1', ComponentType.BrandHeader, { logo_text: '资料库', title: '知识资料库', subtitle: '课程讲义与学习资料', style_type: 'plain' }),
        makeComp('st1', ComponentType.SectionTitle, { title: '精选资料', subtitle: '按主题浏览' }),
        makeComp('al1', ComponentType.ArticleList, { title: '资料列表', limit: 8, columns: 1, layout: 'list' }),
        makeComp('fm1', ComponentType.FormEntry, { title: '领取完整资料', form_title: '填写信息获取资料包', button_text: '立即领取' }),
        makeComp('ct1', ComponentType.ContactInfo, { title: '联系顾问', phone: '400-888-6666', service_time: '工作日 09:00-18:00' }),
      ], '#f0fdfa'),
    },
    {
      id: 2014,
      name: '轻量开店首页模板',
      description: '组件精简的开店首页：轮播、商品列表、公告与 AI 入口，适合三栏轻量店。',
      category: 'home',
      created_at: '',
      priority: 'P1',
      scene: 'sales',
