...
export const asyncRoutes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '内容库', icon: 'Reading', featureModule: 'content' },
      },
      {
        path: 'write',
        name: 'ContentOpsWrite',
        component: () => import('@/views/content-ops/write.vue'),
        meta: { title: '写内容', icon: 'EditPen', hidden: true, featureModule: 'content' },
      },
      {
        path: 'inbox',
        name: 'ContentOpsInbox',
        component: () => import('@/views/content-ops/inbox.vue'),
        meta: { title: '互动', icon: 'ChatDotRound' },
      },
      {
        path: 'settings',
  ...
  },
  {
    ...
    component: Layout,
    name: 'Commerce',
    meta: { title: '商城管理', icon: 'ShoppingCart', featureModule: 'product' },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('@/views/user/service-community.vue'),
        meta: { title: '客服与社群', icon: 'ChatDotRound' },
      },
    ],
  },
  {
    ...
    component: Layout,
    name: 'Order',
    meta: { title: '订单管理', icon: 'List', featureModule: 'product' },
    redirect: '/order/list',
    children: [
      {
        path: 'list',
        ...
        meta: { title: '订单列表', icon: 'Document', featureModule: 'product' },
      },
      {
        path: 'detail/:id',
        name: 'OrderDetail',
        component: () => import('@/views/order/detail.vue'),
        meta: { title: '订单详情', hidden: true, featureModule: 'product' },
      },
      {
        path: 'refund',
        name: 'OrderRefund',
        component: () => import('@/views/order/refund.vue'),
        meta: { title: '退款审核', icon: 'CircleCheck', roles: ['super_admin'], featureModule: 'product' },
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '积分管理', icon: 'Coin', featureModule: 'member' },
      },
      {
        path: 'planet',
        name: 'MemberPlanet',
