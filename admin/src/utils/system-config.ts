...
export const FORM_TO_DB_KEY: Record<string, string> = {
  ...
  wxPayPublicKeyId: 'wx_pay_public_key_id',
  wxPayPublicKey: 'wx_pay_public_key',
...
export const DB_TO_FORM_KEY: Record<string, string> = {
  ...
  wx_pay_public_key_id: 'wxPayPublicKeyId',
  wx_pay_platform_serial: 'wxPayPublicKeyId',
  wxPayPublicKeyId: 'wxPayPublicKeyId',
  wx_pay_public_key: 'wxPayPublicKey',
  wx_pay_platform_public_key: 'wxPayPublicKey',
  wxPayPublicKey: 'wxPayPublicKey',
